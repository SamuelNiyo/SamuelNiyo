                ...
                <ul>
                    ...
                    <li class="dropdown"><!-- Dropdown menu --> <a href="#">Forms</a>
                        <div class="dropdown-content">
                            ...
                            <a href="bookings.php">Booking Form</a>
                            <a href="reviews.php">Reviews Form</a>
                            <a href="categories.php">Category Form</a>   
                            <a href="address.php">Address Form</a> 
                            <a href="roles.php">Roles Form</a>
                            <a href="payment.php">Payment Form</a>
                            <a href="message.php">Message Form</a>
                        </div>
                    </li>
                    <li class="dropdown"><!-- Dropdown menu --> <a href="#">Tables</a>
                        <div class="dropdown-content">
                            ...
                            <a href="bookings_table.php">Booking Table</a>
                            <a href="review_table.php">Reviews Table</a>
                            <a href="category_table.php">Category Table</a>   
                            <a href="address_table.php">Address Table</a> 
                            <a href="roles_tables.php">Roles Table</a>
                            <a href="payment_table.php">Payment Table</a>
                            <a href="message_table.php">Message Table</a>    
                        </div>
                    </li>
