...
<body>
    <center>
        ...
        <section class="forms">
            <form action="service_provider_data.php" method="POST" class="sp" onsubmit="return confirmInsert();">
                ...
                <div class="form-group">
                    ...
                    <select id="address_id" class="input" name="address_id">
                        <?php
                ...
                <label>Rating</label>
                <input type="number" name="rating" required class="input"><br><br>
