            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>{$row['rating']}</td>
                        <td>
                            <a href='/taskrabbit-like platform/serviceprovider_edit.php?serviceprovider_id={$row['serviceprovider_id']}' class='btn btn-primary btn-sm'>Edit</a></td>
                            <td>
                            <a href='/taskrabbit-like platform/serviceprovider_delete.php?serviceprovider_id={$row['serviceprovider_id']}' class='btn btn-danger btn-sm'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
