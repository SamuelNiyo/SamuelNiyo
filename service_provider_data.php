...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO service_providers (serviceprovider_id, user_id, address_id, role_id, description, hourly_rate, rating) 
            VALUES ('$serviceprovider_id', '$user_id', '$address_id', '$role_id', '$description', '$hourly_rate', '$rating')";
